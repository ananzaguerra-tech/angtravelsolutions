...
- ANG Celebrations: marca separada; não fundir com ANG Travel. Evidência histórica de `Celebrations opção 03` foi recuperada da File Library, mas master final deve ser tratado como oficial somente após arquivo-fonte inequívoco/QA.
- ANG Luxury Brazil: opção 30 prevalente, gesto dourado fluido em três traços; `Brazil` com Z.
